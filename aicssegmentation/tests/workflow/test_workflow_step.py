...
class TestWorkflowStep:
    ...
    def test_get_name(self):
        ...
        function = SegmenterFunction(name="intensity_normalization", 
                                     display_name=function_name, 
                                     function="intensity_normalization", 
                                     module="aicssegmentation.core.pre_processing_utils")
        step = WorkflowStep(category=WorkflowStepCategory.PRE_PROCESSING,
                             function=function, step_number=1, parent=[0])

        assert step.name == function_name

    def test_execute_bad_input_fails(self):
        # Arrange
        function = SegmenterFunction(name="single_input", 
    ...
    def test_execute_function_single_input_with_parameters(self):
        # Arrange
        function = SegmenterFunction(name="single_input_with_parameters", 
    ...
    def test_execute_function_list_input(self):
        # Arrange
        function = SegmenterFunction(name="list_input", 
    ...
    def test_execute_function_list_input_with_parameters(self):
        # Arrange
        function = SegmenterFunction(name="list_input_with_parameters", 
