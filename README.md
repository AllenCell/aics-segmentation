...
## Quick Start
```python
from aicssegmentation import Example
...
## Installation
**Stable Release:** `pip install aicssegmentation`<br>
**Development Head:** `pip install git+https://github.com/AllenCell/aicssegmentation.git`

## Documentation
For full package documentation please visit [AllenCell.github.io/aicssegmentation](https://AllenCell.github.io/aicssegmentation).
...
* Turn your project into a GitHub repository:
  ...
  * After a GitHub repo has been created, run the following commands:
    * `git remote add origin git@github.com:AllenCell/aicssegmentation.git`
    * `git push -u origin master`
* Register aicssegmentation with Codecov:
  ...
  * Copy the token provided, go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/AllenCell/aicssegmentation/settings/secrets),
...
generation to work
  ...
  * Go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/AllenCell/aicssegmentation/settings/secrets),
...
* Add branch protections to `master` and `stable`
    * To protect from just anyone pushing to `master` or `stable` (the branches with
    ...
    configurations)
    * Go to your [GitHub repository's settings and under the `Branches` tab](https://github.com/AllenCell/aicssegmentation/settings/branches), click `Add rule` and select the
